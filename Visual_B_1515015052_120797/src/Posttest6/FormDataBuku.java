...
//        }catch(Exception e){JOptionPane.showMessageDialog(null, e.getMessage());}
   ...
   private boolean validasi(String judul){ //method agar tidak ada data yang sama ketika dibuat
...
//    }
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(penulis, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(harga, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void searchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyTyped
        // TODO add your handling code here:
       model.getDataVector().removeAllElements();//mendeklarasikan model yang mengambil data vector dan meremove semua elements
...
//    }
    ...
    private void HapusData(String judull){
        try {
            ...
            //mengosongkan atau menset isi dari textfield dan combobox di frame
            judul.setText("");
    ...
    public void UpdateData(String judul, String penulis, String harga){
       try {
            ...
            stt = con.createStatement();//pembuatan statement
            stt.executeUpdate(sql);//ini eksekusi query
